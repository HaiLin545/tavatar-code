...
class SMPL(nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        vertices, joints, extra = lbs(betas, full_pose, self.v_template,
                               self.shapedirs, self.posedirs,
                               self.J_regressor, self.parents,
                               self.lbs_weights, pose2rot=pose2rot, return_extra=return_extra)
...
class SMPLX(SMPLH):
    ...
    def forward(
        ...
        **kwargs
        ...
        if return_extra:
            vertices, joints, extra = lbs(shape_components, full_pose, self.v_template,
        ...
        output = SMPLXOutput(vertices=vertices if return_verts else None,
                              ...
                              v_shaped=v_shaped,
                              full_pose=full_pose if return_full_pose else None,
                              extra=extra if return_extra else None)
        return output
